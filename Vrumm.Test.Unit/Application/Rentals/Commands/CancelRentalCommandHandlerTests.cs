...
public class CancelRentalCommandHandlerTests
{
    ...
    private readonly Mock<ILogger<CancelRentalCommandHandler>> _loggerMock;
    ...
    public CancelRentalCommandHandlerTests()
    {
        ...
        _loggerMock = new Mock<ILogger<CancelRentalCommandHandler>>();
        _handler = new CancelRentalCommandHandler
            (_unitOfWorkMock.Object, _loggerMock.Object);
    }

    [Fact]
    public async Task Handle_ValidCommand_CancelsRental()
    {
        // Arrange
        ...
        _unitOfWorkMock.Verify(u => u.Rentals.UpdateAsync(It.Is<Rental>(r =>
            ...
            r.Status == RentalStatus.Cancelled)), Times.Once());
